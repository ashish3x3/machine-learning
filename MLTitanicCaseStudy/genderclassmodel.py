...
csv_file_object = csv.reader(open(os.path.join(pathToCsv, "train.csv"), 'rb'))      # Load in the csv file
...
print 'survival table initialized ',survival_table.shape
...
print 'survival table before 0 ',survival_table
survival_table[ survival_table != survival_table ] = 0.0
print 'survival table after 0 ',survival_table
...
# First read in test
test_file = open(os.path.join(pathToCsv,'test.csv'), 'rb')
test_file_object = csv.reader(test_file)
header = test_file_object.next()

# Also open the a new file so I can write to it.
predictions_file = open(os.path.join(pathToCsv,"genderclassmodel.csv"), "wb")
...
# print 'predictions_file_object ', predictions_file_object
# Close out the files
test_file.close()
